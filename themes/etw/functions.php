...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size( 'featuredBlog', 1200, 444, true );
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('bxsliderjs', get_template_directory_uri() . '/js/jquery.bxslider.min.js', array('jquery'), '2.7.1'); // Modernizr
        wp_enqueue_script('bxsliderjs'); // Enqueue it!
        wp_register_script('picturefill', get_template_directory_uri() . '/js/picturefill.js', array('jquery'), '2.7.1'); // Modernizr
        wp_enqueue_script('picturefill'); // Enqueue it!
        wp_register_script('slicknavjs', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array('jquery'), '2.7.1'); // Modernizr
